...
Single Node.js process that connects to WhatsApp, routes messages to Claude Agent SDK running in Docker Container (Linux VMs). Each group has isolated filesystem and memory.
